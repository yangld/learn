rm -f policy.txt
mysql -upekall -pApple12#$ -h mgr1.mysql.pekall.com -P 6446 mdm_reactor -e "select name,description,id,com_id from mdm_new_policy_template where op_tenant_id=7" > policy.txt
./login.sh

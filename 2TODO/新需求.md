...
![[43261655095502_.pic.jpg]]

https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/iPhoneOTAConfiguration/profile-service/profile-service.html#//apple_ref/doc/uid/TP40009505-CH2-SW2



1.	 填写钉钉文档，收集联通部署内容------------
2.	姜睿发的替换nginx证书的逻辑，需要添加到应用管理中。 
3.	bug修改
...
{"query":{"bool":{"must":[{"range":{"activeTime":{"gte":"1651334400000","lte":"1654876799999"}}},{"term":{"appClass":"2"}},{"prefix":{"defOrgCode":"00000000000000010000000000000011"}}]}},"aggs":{"userId":{"terms":{"field":"userId","size":100000},"aggs":{"sum_time":{"sum":{"field":"sumTime"}},"sum_dur":{"sum":{"field":"sumDuration"}},"sum_tra":{"sum":{"field":"sumTraffic"}},"dis_user":{"cardinality":{"field":"activeTime"}},"detail":{"top_hits":{"sort":[{"activeTime":{"order":"desc"}}],"_source":{"includes":["userName","userId","account","orgName","defOrgCode","orgId"]},"size":1}}}}},"sort":[{"activeTime":{"order":"asc"}}]}

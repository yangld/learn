...
| vendor               | string | 是   | 登录方式厂商 INFOSEC: 证书厂商, BUPT :北邮声纹, PEKALL: 口令认证的配置               |
| parameters           | string | 是   | 证书:{   "plaintext": "plaintext",   "signedtext": "signed text",   "tsatext": "tsatext",   "cert": "cert",   "username": "yld02",   "imei": "imei",   "otptype": "otptype",   "otpnum": "otpnum" }, 口令: {   "userName": "yld02",   "password": "petest1111" } , 声纹: {  "account":"yld02", "personId": "yld02",   "sessionToken": "xejkjkrejkjkjkjkre" ,"fileId":"fff6e78debe84486cc18ac38febe"}   sessionToken从获取文本返回结果中获取                                                              |
...
| parameters           | string | 是   | {   "userName": "yld02",   "password": "pekalxxxx"}                            |
| ver                  | string | 否   | 版本号，用于支持parameters参数整体加密, 2: parameters整体需要解密                            |
